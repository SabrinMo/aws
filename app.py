...
app.config['MYSQL_HOST'] = 'database-1.cnseafi3s7rc.us-east-1.rds.amazonaws.com'
app.config['MYSQL_USER'] = 'admin'
app.config['MYSQL_PASSWORD'] = 'Sab103kass**'
app.config['MYSQL_DB'] = 'database-1'
app.secret_key = "my-secret-key"
app.config['UPLOAD_FOLDER'] = UPLOAD_FOLDER
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://admin:Sab103kass**@database-1.cnseafi3s7rc.us-east-1.rds.amazonaws.com/database-1?charset=utf8mb4'
db = SQLAlchemy(app)
sess = Session()
...
webapp.config['S3_BUCKET'] = "bucket369-s"
webapp.config['S3_KEY'] = "AKIATRATH5JVDKBOSLW3"
webapp.config['S3_SECRET'] = "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"
webapp.config['S3_LOCATION'] = 'http://bucket369-s.s3.amazonaws.com/'
...
with app.app_context():
    conn = pymysql.connect(host='database-1.cnseafi3s7rc.us-east-1.rds.amazonaws.com', user='admin', password='Sab103kass**', db='database-1')
        ...
        if file and allowed_file(file.filename):
            ...
            if key_exists:
                ...
                if key_id == null or key_id == '':
                    ...
                    s3.upload_file(Filename=f"{img_path}", Bucket=webapp.config['S3_BUCKET'], Key=webapp.config['S3_KEY'])
                    put_in_memcache(key_id, img_path, img_size)
